...
@misc{Bombe2024QKE,
  author       = {Bombe},
  title        = {Basic implementation of a quantum key exchange protocol using Qiskit},
  year         = {2024},
  url          = {https://github.com/BomBe1939/Basic-implementation-of-a-quantum-key-exchange-protocol-using-Qiskit},
